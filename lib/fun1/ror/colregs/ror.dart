  ...
  void _navigateToDetails(BuildContext context, int index) {
    switch (index) {
      case 0:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Colregs()),
        );
        break;
        case 1:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => FlipCardPage()),
        );
        break;
      case 2:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => DaySignal()),
        );
        break;
